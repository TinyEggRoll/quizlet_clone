import {
    ...
    Box,
    Button,
    Flex, Heading, Icon, Input, Link, Text, Textarea,
    ...
    return (
        <>
            ...
            <Box>
                ...
                <Flex maxW='80rem' h='6.875rem' margin='0 auto' mt='6rem' p='0 2.5rem' align='center' justify='space-between'>
                ...
                <Flex maxW='80rem' margin='0 auto' p='0 2.5rem' justify='space-between' align='center' mt='1.5rem'>
                    ...
                    <Flex w='25rem' justify='space-between' align='center'>
                        ...
                        <Avatar isDisabled bg='gray.300' size='sm' icon={<BiTransfer color='white' size='1.5rem' />} />
                        <Avatar bg='#3ccfcf' size='sm' icon={<MdKeyboard color='white' size='1.5rem' />} />
                    </Flex>
                </Flex>
